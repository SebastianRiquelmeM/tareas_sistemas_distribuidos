...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.interact.form.address</title>
...
<!-- ============================== class title ============================ -->
			<h1 class="classTitle">
				...
				Class CeL.interact.form.address
			</h1>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				form 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_interact_form_address.origin.js.html">address.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.interact.form.address.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.interact.form.address.html#constructor">CeL.interact.form.address</a></b>()
							</div>
							<div class="description">JavaScript 地址輸入表單支援 (address input form)，現有台灣(.TW)可用。</div>
						</td>
					</tr>
				</tbody>
			</table>
