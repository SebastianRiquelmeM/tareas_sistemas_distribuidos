...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.interact.integrate.SVG.</span><b>changeText</b>(text_node, text)
					...
					<div class="description">
						改變 text
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="http://www.w3.org/TR/SVG/text.html" accessdate="2009/12/15 0:2">Text - SVG 1.1 - 20030114</a><tref xlink:href="#ReferencedText"/></dd>
					...
					<span class="light">CeL.interact.integrate.SVG.</span><b>createENS</b>(_ns, _qn, _a, _i)
					...
					<span class="light">CeL.interact.integrate.SVG.</span><b>createNode</b>(_nodeN, _a, _i)
					...
					<a name=".draw_addition"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_addition</b>(num1, num2, svgO, _color, _font)
					
					</div>
					<div class="description">
						use <a href="../symbols/CeL.interact.integrate.SVG.html">CeL.interact.integrate.SVG</a> to draw:
利用 module SVG 物件來演示直式加法。
					...
					<a name=".draw_circle"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_circle</b>(_r, svgO, _color, _fill)
...
繪製圓形。
					...
					<a name=".draw_ellipse"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_ellipse</b>(_rx, _ry, svgO, _color, _fill)
...
繪製橢圓。
					...
					<a name=".draw_long_division"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_long_division</b>(dividend, divisor, digits_after, svgO, _color, _font)
...
利用 module SVG 物件來展示<a href="http://en.wikipedia.org/wiki/Long_division" title="long division">直式除法</a>。<br/>!! 尚有許多 bug<br/>
					...
					<pre class="code">// include moduleCeL.use('net.SVG');//	way 1var SVG_object = new CeL.SVG;SVG_object.attach('panel_for_SVG').show(1);CeL.draw_long_division(452, 34, SVG_object);// You can also put here.//SVG_object.attach('panel_for_SVG').show(1);//	way 2var SVG_object = CeL.draw_long_division(100000, 7);SVG_object.attach('panel_for_SVG').show(1);// 另一次顯示CeL.draw_long_division(100, 7, SVG_object);</pre>
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>TODO: 小數直式除法: 小數點後位數, how many digits after the decimal separator</dd>
					...
					<a name=".draw_multiplication"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_multiplication</b>(num1, num2, svgO, _color, _font)
...
利用 module SVG 物件來演示直式乘法。<br/>TODO: 小數的乘法
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="http://203.71.239.19/math/courses/cs04/M4_6.php" accessdate="2010/1/20 18:5">小數篇：小數的乘法</a></dd>
					...
					<a name=".draw_quadrilateral"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_quadrilateral</b>(_ds, _h, _d, _us, svgO, _color, _fill)
...
畫簡單梯形。
							...
							<dt class="heading">Requires:</dt>
								...
								<dd>split_String_to_Object,set_attribute,XML_node,removeNode,remove_all_child,g_SVG,draw_quadrilateral</dd>
					...
					<a name=".draw_subtraction"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_subtraction</b>(num1, num2, svgO, _color, _font)
...
呼叫 draw_subtraction 來演示直式減法。因為直式加減法的運算與機制過程非常相似，因此我們以 draw_addition 來一併的處理這兩個相似的運算過程。
					...
					<span class="light">CeL.interact.integrate.SVG.</span><b>draw_triangle</b>(_ds, _h, _d, svgO, _color, _fill)
...
畫簡單三角形。
							...
							<dt class="heading">Requires:</dt>
								...
								<dd>split_String_to_Object,set_attribute,XML_node,removeNode,remove_all_child,g_SVG,draw_triangle</dd>
					...
					<span class="light">CeL.interact.integrate.SVG.</span><b>getNodeById</b>(id)
					...
					<span class="light">CeL.interact.integrate.SVG.</span><b>getRandomID</b>(tag)
					...
					<span class="light">CeL.interact.integrate.SVG.</span><b>setRandomID</b>(_n)
...
<!-- ============================== footer ================================= -->
		<div class="fineprint" style="clear:both">
			...
			Documentation generated by <a href="http://code.google.com/p/jsdoc-toolkit/" target="_blank">JsDoc Toolkit</a> 2.4.0 on Sat Aug 20 2011 15:07:31 GMT+0800 (CST)
		</div>
	</body>
</html>
