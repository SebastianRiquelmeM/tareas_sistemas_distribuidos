...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.application.debug</title>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				code.debug 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_application_debug.origin.js.html">debug.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.application.debug.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.application.debug.html#constructor">CeL.application.debug</a></b>()
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.application.debug.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.debug.<b><a href="../symbols/CeL.application.debug.html#.JSalert">JSalert</a></b>(message, wait, title, type)
								</div>
								<div class="description">顯示訊息視窗<br/>alert() 改用VBScript的MsgBox可產生更多效果，但NS不支援的樣子。</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.application.debug.</span><b>JSalert</b>(message, wait, title, type)
					...
					<div class="description">
						顯示訊息視窗<br/>alert() 改用VBScript的MsgBox可產生更多效果，但NS不支援的樣子。
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>message or object</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>wait</b>
									<i>Optional</i>
								</dt>
								<dd>the maximum length of time (in seconds) you want the pop-up message box displayed.</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>title</b>
									<i>Optional</i>
								</dt>
								<dd>title of the pop-up message box.</dd>
							
								<dt>
									<span class="light fixedFont">{Number}</span> <b>type</b>
									<i>Optional</i>
								</dt>
								<dd>type of buttons and icons you want in the pop-up message box.</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Integer}</span> number of the button the user clicked to dismiss the message box.</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="http://msdn.microsoft.com/library/en-us/script56/html/wsmthpopup.asp">Popup Method</a></dd>
