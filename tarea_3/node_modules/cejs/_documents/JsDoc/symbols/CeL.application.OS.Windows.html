...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.application.OS.Windows</title>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				web 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_application_OS_Windows.origin.js.html">Windows.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.application.OS.Windows.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.application.OS.Windows.html#constructor">CeL.application.OS.Windows</a></b>()
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.application.OS.Windows.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.OS.Windows.<b><a href="../symbols/CeL.application.OS.Windows.html#.JSA_to_VBA">JSA_to_VBA</a></b>(array)
								</div>
								<div class="description">轉換JS Array成為VB的Safe Array.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.OS.Windows.<b><a href="../symbols/CeL.application.OS.Windows.html#.VBA_to_JSA">VBA_to_JSA</a></b>(vba)
								</div>
								<div class="description">轉換 VB 的 Safe Array 成為 JS Array.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.OS.Windows.<b><a href="../symbols/CeL.application.OS.Windows.html#.VBNothing">VBNothing</a></b>()
								</div>
								<div class="description">取得 VB 的 Nothing</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.application.OS.Windows</b>()
				</div>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.application.OS.Windows.</span><b>JSA_to_VBA</b>(array)
					...
					<div class="description">
						轉換JS Array成為VB的Safe Array.Safe Array To JS Array: plaese use new VBArray().JScriptの配列は実際にはCSV文字列だったりする。VBScriptのvartypeに食わせると8(VT_STRING)が返ってくることからもわかる。
							...
							<dt class="heading">See:</dt>
								...
								<dd>http://www.microsoft.com/japan/msdn/japan/msdn/library/ja/script56/html/js56jsobjvbarray.asp</dd>
					...
					<span class="light">CeL.application.OS.Windows.</span><b>VBA_to_JSA</b>(vba)
					...
					<span class="light">CeL.application.OS.Windows.</span><b>VBNothing</b>()
