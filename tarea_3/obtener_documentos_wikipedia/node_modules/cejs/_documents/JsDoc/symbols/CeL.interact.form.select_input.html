...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.interact.form.select_input</title>
...
<!-- ============================== class title ============================ -->
			<h1 class="classTitle">
				...
				Class CeL.interact.form.select_input
			</h1>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				form 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_interact_form_select_input.origin.js.html">select_input.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.interact.form.select_input.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.interact.form.select_input.html#constructor">CeL.interact.form.select_input</a></b>()
							</div>
							<div class="description">提供有選單的  input</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.interact.form.select_input</b>()
				</div>
				...
				<div class="description">
					提供有選單的  input
						...
						<dt class="heading">See:</dt>
							...
							<dd>http://dojocampus.org/explorer/#Dijit_Form%20Controls_Filtering%20Select_Basic</dd>
