...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.application.OS.Windows.WMI</title>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				WMI 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_application_OS_Windows_WMI.origin.js.html">WMI.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.application.OS.Windows.WMI.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.application.OS.Windows.WMI.html#constructor">CeL.application.OS.Windows.WMI</a></b>()
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.application.OS.Windows.WMI.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.OS.Windows.WMI.<b><a href="../symbols/CeL.application.OS.Windows.WMI.html#.CIDR_to_IP">CIDR_to_IP</a></b>(CIDR, IP)
								</div>
								<div class="description">get CIDR data</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.OS.Windows.WMI.<b><a href="../symbols/CeL.application.OS.Windows.WMI.html#.get_net_info">get_net_info</a></b>(type)
								</div>
								<div class="description">取得網卡設定的IP地址</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.OS.Windows.WMI.<b><a href="../symbols/CeL.application.OS.Windows.WMI.html#.set_net_info">set_net_info</a></b>(to_s, from)
								</div>
								<div class="description">改變網卡的IP地址: change IP, set IP</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.application.OS.Windows.WMI</b>()
				</div>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.application.OS.Windows.WMI.</span><b>CIDR_to_IP</b>(CIDR, IP)
					...
					<div class="description">
						get CIDR data
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Number}</span> <b>CIDR</b>
									
								</dt>
								<dd>CIDR mask bits, 0~32</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>IP</b>
									
								</dt>
								<dd>IPv4, e.g., 1.2.3.4</dd>
					...
					<a name=".get_net_info"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.application.OS.Windows.WMI.</span><b>get_net_info</b>(type)
					...
					<pre class="code">IP=get_net_info().netif[0].IPAddress[0];with(get_net_info())alert(UserName+'\n'+Name+'\n'+Workgroup+'\n'+Domain+'\n'+BootupState);</pre>
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>default type: ip setted interfaces only, 1: all interfaces, 2: 實體 net interfaces(網路卡，無線)</dd>
					...
					<a name=".set_net_info"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.application.OS.Windows.WMI.</span><b>set_net_info</b>(to_s, from)
					...
					<pre class="code">set_net_info({IP:'163.16.20.212',Gateway:254});sl(set_net_info({IP:'163.16.20.30',Gateway:254}));WScript.Quit();</pre>
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>IP or {IP:''||[], CIDR:24||.CIDR_notation, Subnet:''||[], DNS:''||[], Gateway:254||[], GatewayOrder:''||[]}</dd>
							
								<dt>
									<b>from</b>
									
								</dt>
								<dd>IP or netif No.</dd>
							...
							<dl class="detailList">
							<dt class="heading">Since:</dt>
								<dd>2009/5/7 0:24:5	加強2010/3/3 10:41:17	a work version</dd>
							</dl>
							</dl>
							...
							<dt class="heading">Requires:</dt>
								...
								<dd>WMI_data,VBA_to_JSA,JSArrayToSafeArray,CIDR_to_IP</dd>
