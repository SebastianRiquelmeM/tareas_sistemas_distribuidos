...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.interact.integrate.map</title>
...
<!-- ============================== class title ============================ -->
			<h1 class="classTitle">
				...
				Class CeL.interact.integrate.map
			</h1>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				map 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_interact_integrate_map.origin.js.html">map.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.interact.integrate.map.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.interact.integrate.map.html#constructor">CeL.interact.integrate.map</a></b>()
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.interact.integrate.map.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">CeL.interact.integrate.map.<b><a href="../symbols/CeL.interact.integrate.map.html#.parse_address">parse_address</a></b>(address)
								</div>
								<div class="description">解析地址</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.interact.integrate.map</b>()
				</div>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<a name=".parse_address"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.integrate.map.</span><b>parse_address</b>(address)
					...
					<div class="description">
						解析地址
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{String}</span> <b>address</b>
