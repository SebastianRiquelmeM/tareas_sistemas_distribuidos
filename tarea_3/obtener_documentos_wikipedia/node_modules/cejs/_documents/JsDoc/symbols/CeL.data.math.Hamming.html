...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.data.math.Hamming</title>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				Hamming Code 的 constructor
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_data_math_Hamming.origin.js.html">Hamming.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.data.math.Hamming.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.Hamming.html#constructor">CeL.data.math.Hamming</a></b>()
							</div>
							<div class="description">Hamming code</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class CeL.data.math.Hamming.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								CeL.data.math.Hamming.<b><a href="../symbols/CeL.data.math.Hamming.html#.reverse">reverse</a></b>
								</div>
								<div class="description">是否左右顛倒。default: data[1,2,.</div>
							</td>
						</tr>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.data.math.Hamming.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.math.Hamming.<b><a href="../symbols/CeL.data.math.Hamming.html#.decode">decode</a></b>(code)
								</div>
								<div class="description">decode Hamming Code to data</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.math.Hamming.<b><a href="../symbols/CeL.data.math.Hamming.html#.encode">encode</a></b>(data, no_reverse)
								</div>
								<div class="description">encode data to Hamming Code.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.math.Hamming.<b><a href="../symbols/CeL.data.math.Hamming.html#.show">show</a></b>(bit_length)
								</div>
								<div class="description">顯示 Hamming Code 的計算方法</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.math.Hamming.<b><a href="../symbols/CeL.data.math.Hamming.html#.split_code">split_code</a></b>(code)
								</div>
								<div class="description">將 Hamming Code 分成 data & check bits</div>
							</td>
						</tr>
...
<!-- ============================== field details ========================== -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.math.Hamming.</span><b>reverse</b>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.math.Hamming.</span><b>decode</b>(code)
					...
					<span class="light">CeL.data.math.Hamming.</span><b>encode</b>(data, no_reverse)
					...
					<div class="description">
						encode data to Hamming Code.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> encoded Hamming Code</dd>
					...
					<span class="light">CeL.data.math.Hamming.</span><b>show</b>(bit_length)
					...
					<div class="description">
						顯示 Hamming Code 的計算方法
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Number}</span> <b>bit_length</b>
									
								</dt>
								<dd>bit length. e.g., 8, 16.</dd>
					...
					<span class="light">CeL.data.math.Hamming.</span><b>split_code</b>(code)
					...
					<div class="description">
						將 Hamming Code 分成 data & check bits
							...
							<dt class="heading">Returns:</dt>
								...
								<dd>[資料位元 data bits, 檢查位元 check bits (parity bits)]</dd>
