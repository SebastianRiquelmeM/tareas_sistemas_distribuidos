...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.application.OS.Windows.HTA</title>
...
<!-- ============================== class title ============================ -->
			<h1 class="classTitle">
				...
				Class CeL.application.OS.Windows.HTA
			</h1>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				web HTA 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_application_OS_Windows_HTA.origin.js.html">HTA.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.application.OS.Windows.HTA.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.application.OS.Windows.HTA.html#constructor">CeL.application.OS.Windows.HTA</a></b>()
							</div>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class CeL.application.OS.Windows.HTA.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								CeL.application.OS.Windows.HTA.<b><a href="../symbols/CeL.application.OS.Windows.HTA.html#.getClipboardText">getClipboardText</a></b>
								</div>
								<div class="description">WSH 環境中取得剪貼簿的資料</div>
							</td>
						</tr>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.application.OS.Windows.HTA.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.OS.Windows.HTA.<b><a href="../symbols/CeL.application.OS.Windows.HTA.html#.IEA">IEA</a></b>(URL)
								</div>
								<div class="description">Internet Explorer Automation tool</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.application.OS.Windows.HTA</b>()
				</div>
...
<!-- ============================== field details ========================== -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.application.OS.Windows.HTA.</span><b>getClipboardText</b>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">{IEA}</span>
					<span class="light">CeL.application.OS.Windows.HTA.</span><b>IEA</b>(URL)
					...
					<div class="description">
						Internet Explorer Automation tool
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{IEA}</span> </dd>
