...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.data.code.compatibility</title>
...
<!-- ============================== class title ============================ -->
			<h1 class="classTitle">
				...
				Class CeL.data.code.compatibility
			</h1>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				相容性 test 專用的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_data_code_compatibility.origin.js.html">compatibility.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.data.code.compatibility.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.data.code.compatibility.html#constructor">CeL.data.code.compatibility</a></b>()
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.data.code.compatibility.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.compatibility.<b><a href="../symbols/CeL.data.code.compatibility.html#.is_DOM">is_DOM</a></b>(name)
								</div>
								<div class="description">判斷為 DOM。</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.compatibility.<b><a href="../symbols/CeL.data.code.compatibility.html#.is_HTA">is_HTA</a></b>(id)
								</div>
								<div class="description">Are we run in HTA?<br/>** HTA 中應該在 onload 中呼叫，否則 document.getElementsByTagName 不會有東西！</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.compatibility.<b><a href="../symbols/CeL.data.code.compatibility.html#.is_web">is_web</a></b>(W3CDOM)
								</div>
								<div class="description">Are we in a web environment?</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.data.code.compatibility</b>()
				</div>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.code.compatibility.</span><b>is_DOM</b>(name)
					...
					<div class="description">
						判斷為 DOM。
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>various name @ name-space window. e.g., document, location</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Boolean}</span> various is object of window</dd>
					...
					<span class="light">CeL.data.code.compatibility.</span><b>is_HTA</b>(id)
					...
					<div class="description">
						Are we run in HTA?<br/>** HTA 中應該在 onload 中呼叫，否則 document.getElementsByTagName 不會有東西！
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>HTA tag id (only used in low version that we have no document.getElementsByTagName)</dd>
					...
					<span class="light">CeL.data.code.compatibility.</span><b>is_web</b>(W3CDOM)
					...
					<div class="description">
						Are we in a web environment?
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>Are we in a W3C DOM environment?</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd>We're in a web environment.</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="../symbols/_global_.html#use">use</a> lazy evaluation</dd>
