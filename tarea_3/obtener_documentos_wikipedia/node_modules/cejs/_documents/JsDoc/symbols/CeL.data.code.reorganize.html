...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.data.code.reorganize</title>
...
<!-- ============================== class title ============================ -->
			<h1 class="classTitle">
				...
				Class CeL.data.code.reorganize
			</h1>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				程式碼重整重構相關之 functions。
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_data_code_reorganize.origin.js.html">reorganize.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.data.code.reorganize.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.data.code.reorganize.html#constructor">CeL.data.code.reorganize</a></b>()
							</div>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class CeL.data.code.reorganize.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#._.generate_code.ddI">_.generate_code.ddI</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#._.generate_code.dsp">_.generate_code.dsp</a></b>
								</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.data.code.reorganize.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.add_code">add_code</a></b>(file_name, Vlist, start_string, end_string)
								</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.add_use">add_use</a></b>(code)
								</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.destory_script">destory_script</a></b>(code, addFN)
								</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.generate_code">generate_code</a></b>(Vlist, new_line, direct_input)
								</div>
								<div class="description">利用[*現有的環境*]及變數設定生成code，因此並不能完全重現所有設定，也無法判別函數間的相依關係。</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.get_all_functions">get_all_functions</a></b>(script_filename)
								</div>
								<div class="description">取得[script_filename].wsf中不包括自己（[script_filename].js），其餘所有 .js 的code。</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.null_code">null_code</a></b>(length, type)
								</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.reduce_code">reduce_code</a></b>(code, mode)
								</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.reduce_code.reduce_space">reduce_code.reduce_space</a></b>(code)
								</div>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.reduce_script">reduce_script</a></b>(original_ScriptFileName, output_ScriptFileName, flag)
								</div>
								<div class="description">精簡整個檔的程式碼…and test程式是否有語法不全處（例如沒加';'）</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.code.reorganize.<b><a href="../symbols/CeL.data.code.reorganize.html#.rJS">rJS</a></b>(flag)
								</div>
...
<!-- ============================== field details ========================== -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.code.reorganize.</span><b>_.generate_code.ddI</b>
					...
					<span class="light">{String}</span>
					<span class="light">CeL.data.code.reorganize.</span><b>_.generate_code.dsp</b>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.code.reorganize.</span><b>add_code</b>(file_name, Vlist, start_string, end_string)
					...
					<span class="light">CeL.data.code.reorganize.</span><b>add_use</b>(code)
					...
					<span class="light">CeL.data.code.reorganize.</span><b>destory_script</b>(code, addFN)
					...
					<span class="light">CeL.data.code.reorganize.</span><b>generate_code</b>(Vlist, new_line, direct_input)
					...
					<span class="light">CeL.data.code.reorganize.</span><b>get_all_functions</b>(script_filename)
					...
					<span class="light">{String}</span>
					<span class="light">CeL.data.code.reorganize.</span><b>null_code</b>(length, type)
					...
					<span class="light">{String}</span>
					<span class="light">CeL.data.code.reorganize.</span><b>reduce_code</b>(code, mode)
					...
					<span class="light">{String}</span>
					<span class="light">CeL.data.code.reorganize.</span><b>reduce_code.reduce_space</b>(code)
					...
					<span class="light">CeL.data.code.reorganize.</span><b>reduce_script</b>(original_ScriptFileName, output_ScriptFileName, flag)
					...
					<span class="light">CeL.data.code.reorganize.</span><b>rJS</b>(flag)
