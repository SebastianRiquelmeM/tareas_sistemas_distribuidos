...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.application.storage.file</title>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				檔案操作相關之 function。
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_application_storage_file.origin.js.html">file.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.application.storage.file.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.application.storage.file.html#constructor">CeL.application.storage.file</a></b>()
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.application.storage.file.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.storage.file.<b><a href="../symbols/CeL.application.storage.file.html#.determine_base_path">determine_base_path</a></b>(base_path_structure, path_now)
								</div>
								<div class="description">determine base path.</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.storage.file.<b><a href="../symbols/CeL.application.storage.file.html#.is_absolute_path">is_absolute_path</a></b>(path)
								</div>
								<div class="description">is absolute or relative path, not very good solution</div>
							</td>
						</tr>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.application.storage.file.<b><a href="../symbols/CeL.application.storage.file.html#.parse_path">parse_path</a></b>(path)
								</div>
								<div class="description">cf: getFN()</div>
							</td>
						</tr>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.application.storage.file</b>()
				</div>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<a name=".determine_base_path"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					<span class="light">{String}</span>
					<span class="light">CeL.application.storage.file.</span><b>determine_base_path</b>(base_path_structure, path_now)
					...
					<pre class="code">alert(determine_base_path('kanashimi/www/cgi-bin/game/'));</pre>
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{String}</span> <b>base_path_structure</b>
									
								</dt>
								<dd>base path 的範本結構</dd>
							
								<dt>
									<span class="light fixedFont">{String}</span> <b>path_now</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> 推測的 base path full path</dd>
					...
					<a name=".is_absolute_path"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.application.storage.file.</span><b>is_absolute_path</b>(path)
					...
					<span class="light">CeL.application.storage.file.</span><b>parse_path</b>(path)
