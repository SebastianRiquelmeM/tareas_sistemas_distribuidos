...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.data.CSV</title>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				CSV data 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_data_CSV.origin.js.html">CSV.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.data.CSV.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.data.CSV.html#constructor">CeL.data.CSV</a></b>()
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.data.CSV.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.CSV.<b><a href="../symbols/CeL.data.CSV.html#.parse_CSV">parse_CSV</a></b>(_t, doCheck, hasTitle)
								</div>
								<div class="description">parse CSV data to JSON	讀入 CSV 檔</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.CSV.</span><b>parse_CSV</b>(_t, doCheck, hasTitle)
					...
					<pre class="code">//	to use:var data=parse_CSV('~');data[_line_][_field_]//	hasTitle:var data = parse_CSV('~',0,1);//data[_line_][data.t[_title_]]//	then:data.tA	=	title linedata.t[_field_name_]	=	field number of titledata.it	=	ignored title arraydata[num]	=	the num-th line (num: 0,1,2,..)</pre>
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{String}</span> <b>_t</b>
									
								</dt>
								<dd>CSV text data</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>doCheck</b>
									
								</dt>
								<dd>check if data is valid</dd>
							
								<dt>
									<span class="light fixedFont">{Boolean}</span> <b>hasTitle</b>
									
								</dt>
								<dd>there's a title line</dd>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> [ [L1_1,L1_2,..], [L2_1,L2_2,..],.. ]</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="http://www.jsdb.org/" accessdate="2010/1/1 0:53">JSDB: JavaScript for databases</a>,<a href="http://hax.pie4.us/2009/05/lesson-of-regexp-50x-faster-with-just.html" accessdate="2010/1/1 0:53">John Hax: A lesson of RegExp: 50x faster with just one line patch</a></dd>
