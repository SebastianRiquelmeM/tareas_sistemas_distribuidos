...
set_cookie('expires',0);</pre>
					...
					<div class="description">
						Translate a native Object contains key/value pair set to a query string.TODO
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Object}</span> <b>query_Object</b>
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{String}</span> query string</dd>
					...
					<a name=".toggle_display"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.DOM.</span><b>toggle_display</b>(element, type)
					...
					<div class="description">
						toggle/swap display and visibility.display:none or visibility:hidden.TODO: computed style
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{String|Number}</span> <b>type</b>
									
								</dt>
								<dd>show or hidden or set the status type:			{Number} type: 0: hidden(→none), 1: show(→block), 2||undefined: switch, others: get status only with no change			{String} type: set CSS: display type: none, '', block, inline, list-item. 其他恐造成 error?</dd>
							...
							<dl class="detailList">
							<dt class="heading">Since:</dt>
								<dd>2010/4/1 10:24:43 rewrite</dd>
							</dl>
							</dl>
							...
							<dt class="heading">Requires:</dt>
								...
								<dd>[_.get_element],[_.get_style]</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd>http://www.w3schools.com/CSS/pr_class_visibility.asphttp://www.w3schools.com/css/pr_class_display.asphttp://www.javaeye.com/topic/140784	通過element.style對象只能取得內聯的樣式，也就是說只能取得html標籤裡寫的屬性。</dd>
					...
					<a name=".Unicode_to_HTML"> </a>
					<div class="fixedFont">&lt;static&gt; 
					
					
					<span class="light">CeL.interact.DOM.</span><b>Unicode_to_HTML</b>(text, flags, ignore_tags)
					...
					<div class="description">
						Translate Unicode text to HTML code
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>flags, f&1!=0: turn \t, (f&2)==0: \n→<br/>, f==4: to quoted</dd>
							
								<dt>
									<b>ignore_tags</b>
									
								</dt>
								<dd>e.g., {object:{src:/^https?:\/\//},img:{src:/^https?:\/\//},a:{href:/^https?:\/\//}}</dd>
					...
					<span class="light">CeL.interact.DOM.</span><b>XML_node</b>(tag, propertyO, insertBeforeO, innerObj, styleO)
					...
					<div class="description">
						create new HTML/XML <a href="https://developer.mozilla.org/en/DOM/node">node</a>(<a href="https://developer.mozilla.org/en/DOM/element">element</a>)
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>object that we wnat to insert before it</dd>
							
								<dt>
									<b>innerObj</b>
									
								</dt>
								<dd>inner object(s)</dd>
							...
							<dl class="detailList">
							<dt class="heading">Since:</dt>
								<dd>2006/9/6 20:29,11/12 22:13</dd>
							</dl>
							</dl>
