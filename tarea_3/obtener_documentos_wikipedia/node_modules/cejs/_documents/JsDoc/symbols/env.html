...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - env</title>
...
<ul class="classList">
	...
	<li><a href="../symbols/env.html">env</a></li>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				環境變數 (environment variables) 與程式會用到的 library 相關變數。
...
<!-- ============================== constructor summary ==================== -->			
			...
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class env.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/env.html#constructor">env</a></b>(name, value)
							</div>
							<div class="description">取得/設定環境變數 enumeration<br/>（雖然不喜歡另開 name-space，但以 2009 當下的 JsDoc Toolkit 來說，似乎沒辦法創造 enumeration。）</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== footer ================================= -->
		<div class="fineprint" style="clear:both">
			...
			Documentation generated by <a href="http://code.google.com/p/jsdoc-toolkit/" target="_blank">JsDoc Toolkit</a> 2.3.3-beta on Sun Sep 19 2010 07:47:16 GMT+0800 (CST)
		</div>
	</body>
</html>
