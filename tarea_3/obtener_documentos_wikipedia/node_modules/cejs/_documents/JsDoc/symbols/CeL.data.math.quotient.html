...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>JsDoc Reference - CeL.data.math.quotient</title>
...
<!-- ============================== class summary ========================== -->			
			<p class="description">
				...
				quotient 的 functions
					...
					<br /><i>Defined in: </i> <a href="../symbols/src/D__USB_cgi-bin_lib_JS_data_math_quotient.origin.js.html">quotient.origin.js</a>.
				
			</p>

<!-- ============================== constructor summary ==================== -->			
			
			<table class="summaryTable" cellspacing="0" summary="A summary of the constructor documented in the class CeL.data.math.quotient.">
				...
				<tbody>
					<tr>
						...
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.quotient.html#constructor">CeL.data.math.quotient</a></b>(numerator, denominator, approximate)
							</div>
							<div class="description">有理數 rational number，有理数全体のつくる集合はしばしば、商を意味する quotient の頭文字をとり、太字の Q で表す。<br/>若要輸入不同基底的數值，請用 parse_base()</div>
						</td>
					</tr>
				</tbody>
			</table>
...
<!-- ============================== properties summary ===================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the fields documented in the class CeL.data.math.quotient.">
					...
					<tbody>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.quotient.html#compare_to">compare_to</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.quotient.html#count">count</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								CeL.data.math.quotient.<b><a href="../symbols/CeL.data.math.quotient.html#.digit_char">digit_char</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.quotient.html#reduce">reduce</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								CeL.data.math.quotient.<b><a href="../symbols/CeL.data.math.quotient.html#.repetend_separator">repetend_separator</a></b>
								</div>
								<div class="description">循環節分隔符號： {String} 整數.</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.quotient.html#to_base">to_base</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.quotient.html#to_decimal">to_decimal</a></b>
								</div>
						...
						<tr>
							...
							<td class="nameDescription">
								<div class="fixedFont">
								<b><a href="../symbols/CeL.data.math.quotient.html#to_print_mode">to_print_mode</a></b>
								</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class CeL.data.math.quotient.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&lt;static&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">CeL.data.math.quotient.<b><a href="../symbols/CeL.data.math.quotient.html#.parse_base">parse_base</a></b>(number, base, digit_char)
								</div>
...
<!-- ============================== constructor details ==================== -->		
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>CeL.data.math.quotient</b>(numerator, denominator, approximate)
				</div>
...
<!-- ============================== field details ========================== -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.math.quotient.</span><b>digit_char</b>
					...
					<span class="light">CeL.data.math.quotient.</span><b>repetend_separator</b>
...
<!-- ============================== method details ========================= -->		
				...
				<div class="sectionTitle">
					...
					<span class="light">CeL.data.math.quotient.</span><b>parse_base</b>(number, base, digit_char)
